export const Login = () => {
  return (
    <div className="sm:py-5 md:py-10 lg:py-20 lg:my-20">
      <div className="block lg:flex bg-white dark:bg-gray-800 rounded-lg">
        <div className="w-full lg:w-1/6 flex lg:border-r border-gray-400">
        ...
        <div className="w-full lg:w-2/3 px-6 py-16 lg:shadow-lg">
          ...
          <form>
            ...
            <div className="block md:flex items-center justify-between">
              ...
              <a
                className="text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-600 no-underline block mt-3"
                href="/password/reset"
              >
